...
//
// This is the sanity-check contract from the official Nox "Hello World"
// guide (docs.noxprotocol.io/getting-started/hello-world), used here only
// to confirm the toolchain (Hardhat + Nox package + Sepolia RPC) works
// before building the real ConfidentialTreasury contract.
